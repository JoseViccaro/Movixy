...
export const HomePage = lazy(() => import('@/presentation/pages/Home/Home').then(m => ({ default: m.HomePage })));
...
export const MoviesPage = lazy(() => import('@/presentation/pages/Movies/MoviesPage').then(m => ({ default: m.MoviesPage })));
...
export const NewPage = lazy(() => import('@/presentation/pages/New/NewPage'));
